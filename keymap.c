...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_ESC, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  KC_BSPC,   KC_MINUS, KC_EQUAL, KC_LBRACKET, KC_RBRACKET
),
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, _______,
